...
{
    public class GetYearlyReminderQueryHandler (IReminderRepository _reminderRepository, UserInfoToken _userInfo) : IRequestHandler<GetYearlyReminderQuery, List<CalenderReminderDto>>
    {
