...
echo -e "${GREEN}Starting Optimized Frontend Deployment to $SERVER_IP...${NC}"
...
echo -e "${GREEN}Zipping Frontend Build...${NC}"
cd AngularFrontend/dist/document-management/browser
